   ...
   <div class="vx-row">
    <div class="vx-col w-1/7">
     ...
     <input type="file" class="border p-2 rounded w-full" name="inventory_images" ref="files"
      accept=".jpg, .png , .jpeg" style="border: 1px solid rgba(0, 0, 0, 0.2)" data-vv-as="image upload"
      @change="handleImageUpload" multiple />
     <span class="text-danger text-xs" v-show="errors.has(`inventory_images`)">{{ errors.first(`inventory_images`)
     }}</span>
    </div>
    <div class="vx-col w-1/7">
    ...
    <div class="vx-col w-1/7">
     ...
     <span class="text-danger text-xs" v-show="errors.has(`inventory_import`)">{{ errors.first(`inventory_import`)
     }}</span>
    </div>
    <div class="vx-col w-1/7">
     <label class="vs-input--label block">&nbsp;</label>
