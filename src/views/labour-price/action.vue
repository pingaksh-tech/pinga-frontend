        ...
        <div class="vx-row">
          <div class="vx-col w-full px-8">
            ...
            <div class="vx-row mb-2">
              <vs-input icon="icon icon-package" icon-pack="feather" class="w-full" v-validate="'required|integer|min_value:0'"
                v-model="form.regular_price" type="number" label="Regular Price *" name="regular_price" data-vv-as="Regular Price"
                id="regular_price" />
              <span class="text-danger text-sm" v-show="errors.has('regular_price')">{{ errors.first('regular_price')
                }}</span>
            </div>
            ...
            <div class="vx-row mb-2">
              ...
              <select-2 class="w-full category-input" name="collection" placeholder="Select Collection"
                :value="form.collection_id" @input="(item) => (form.collection_id = item && item.value)" autocomplete
                :ssr="true"  v-validate="'required'" action="common/getCollections"
                data-vv-as="Collection" />
              <span class="text-danger text-sm" v-show="errors.has('collection')">{{
